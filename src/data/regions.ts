...
//   - 서울/인천/부산: ARTIST_PLACES(places.ts, regionId로 구분) 기반 아티스트 장소 +
//     TourAPI 지역 명소를 함께 써서 루트 생성(useRouteOptions.ts 참고)
...
export interface Region {
  ...
  /** 실제 아티스트-장소 연결 데이터가 있는 지역만 채움(현재 서울/인천/부산) */
...
export const REGIONS: Region[] = [
  {
    ...
    // 서울 장소(164곳) 중 실제로 연관된 개수 기준 최다 아티스트(53곳).
    representativeArtistId: "enhypen",
  },
  {
    id: "incheon",
    nameKo: "인천",
    ...
    // 인천 장소(10곳) 중 실제로 연관된 개수 기준 최다 아티스트(5곳).
    representativeArtistId: "bts",
  },
  {
    id: "busan",
    nameKo: "부산",
    ...
    // 부산 장소(13곳) 중 뉴진스가 BTS와 공동 최다(5곳) — '뉴진스 코드 in 부산' 예능
    // 촬영지라는 지역 서사가 뚜렷해서 부산 대표로는 뉴진스를 골랐다.
    representativeArtistId: "newjeans",
  },
  {
    id: "gangwon",
    nameKo: "강원",
